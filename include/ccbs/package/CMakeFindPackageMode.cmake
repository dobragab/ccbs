...
# NOTE ccbs: this is badly patched to work.
# This must be in the same directory as cmake_find_package.hpp.
function(try_compile RESULT_VAR)
  set(RESULT_VAR TRUE)
endfunction()

function(try_run RUN_RESULT_VAR COMPILE_RESULT_VAR)
  set(COMPILE_RESULT_VAR TRUE)
  set(RUN_RESULT_VAR 0)
endfunction()

set(CMAKE_CXX_COMPILER_LOADED ON)
...
function(set_link_flags_var _packageName)
  ...
  elseif(DEFINED ${_packageName}_LIBRARY)
    set(libs ${_packageName}_LIBRARY)
  elseif(DEFINED ${PACKAGE_NAME}_LIBRARY)
    set(libs ${PACKAGE_NAME}_LIBRARY)
  endif()
...
find_package("${NAME}" QUIET ${ARGUMENTS})
